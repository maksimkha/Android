...
class GameViewModel  : ViewModel() {
    ...
    var gameStateListener = object : ValueEventListener {
    ...
    var turnListener = object : ValueEventListener{
        override fun onDataChange(dataSnapshot: DataSnapshot) {
    ...
    var endRefListener = object : ValueEventListener {
        override fun onDataChange(dataSnapshot: DataSnapshot) {
    ...
    fun setBtnListener(button : Button, j: Int, i : Int){
